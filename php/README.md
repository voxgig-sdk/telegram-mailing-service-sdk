...
print_r(array_map(fn($item) => $item->data_get(), $mailing));
```
...
```
php/
├── telegrammailingservice_sdk.php          -- Main SDK class
...
The main class (`telegrammailingservice_sdk.php`) exports the SDK class
