...
// TelegramMailingService SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TelegramMailingServiceSDK::test)
...
{
    private const SDK_CLASS = 'TelegramMailingServiceSDK';
    ...
    private const SDK_BASE = 'telegrammailingservice_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../telegrammailingservice_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
