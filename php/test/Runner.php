...
class TelegramMailingServiceTestRunner
{
    ...
    {
        $live = self::getenv('TELEGRAMMAILINGSERVICE_TEST_LIVE');
        $override = self::getenv('TELEGRAMMAILINGSERVICE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TELEGRAMMAILINGSERVICE_TEST_EXPLAIN');
