...
// TelegramMailingService SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TelegramMailingServiceMakeRequest
{
    public static function call(TelegramMailingServiceContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TelegramMailingServiceResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TelegramMailingServiceResponse($fetched);
        } else {
