...
// TelegramMailingService SDK telemetry feature
...
class TelegramMailingServiceTelemetryFeature extends TelegramMailingServiceBaseFeature
{
    ...
    private function _close(TelegramMailingServiceContext $ctx, bool $ok): void
    {
