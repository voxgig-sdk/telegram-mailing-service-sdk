...
// TelegramMailingService SDK debug feature
...
class TelegramMailingServiceDebugFeature extends TelegramMailingServiceBaseFeature
{
    ...
    private function _finish(TelegramMailingServiceContext $ctx, bool $ok): void
    {
