...
// TelegramMailingService SDK rbac feature
...
class TelegramMailingServiceRbacFeature extends TelegramMailingServiceBaseFeature
{
    ...
    private function _required(TelegramMailingServiceContext $ctx): ?string
    {
    ...
    private function _reject(TelegramMailingServiceContext $ctx, string $required): void
    {
    ...
    private function _track(TelegramMailingServiceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
