...
// TelegramMailingService SDK audit feature
...
class TelegramMailingServiceAuditFeature extends TelegramMailingServiceBaseFeature
{
    ...
    private function _emit(TelegramMailingServiceContext $ctx, string $outcome): void
    {
