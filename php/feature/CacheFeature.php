...
// TelegramMailingService SDK cache feature
...
class TelegramMailingServiceCacheFeature extends TelegramMailingServiceBaseFeature
{
    ...
    private function _through(TelegramMailingServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
