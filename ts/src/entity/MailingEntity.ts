...
} from '../TelegramMailingServiceSDK'
...
class MailingEntity extends TelegramMailingServiceEntityBase<Mailing> {
  ...
  make(this: MailingEntity) {
    return new MailingEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: MailingLoadMatch, ctrl?: Control): Promise<MailingEntity> {
  ...
  async list(this: any, reqmatch?: MailingListMatch, ctrl?: Control): Promise<MailingEntity[]> {
  ...
  async create(this: any, reqdata?: MailingCreateData, ctrl?: Control): Promise<MailingEntity> {
  ...
  async remove(
    this: any, reqmatch?: MailingRemoveMatch, ctrl?: Control,
  ): Promise<MailingEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<MailingEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
