...
const TelegramMailingServiceError_1 = require("./TelegramMailingServiceError");
...
class Context {
    ...
    error(code, msg) {
        return new TelegramMailingServiceError_1.TelegramMailingServiceError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
