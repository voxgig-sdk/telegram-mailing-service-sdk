...
type Args struct {
	Entity string         `json:"entity" jsonschema:"mailing"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TelegramMailingServiceSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "telegram-mailing-service_list",
		Description: "List records from TelegramMailingService. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "telegram-mailing-service_load",
		Description: "Load a single record from TelegramMailingService. " +
...
func runOp(client *sdk.TelegramMailingServiceSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TelegramMailingServiceSDK, name string) (sdk.TelegramMailingServiceEntity, error) {
	switch strings.ToLower(name) {
	case "mailing":
		return client.Mailing(nil), nil
