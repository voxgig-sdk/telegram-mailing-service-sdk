// Command TelegramMailingService-mcp is an MCP server exposing the TelegramMailingService
// SDK as MCP tools.
//
// Two tools are registered:
//
//	TelegramMailingService_list  — list records of an entity
//	TelegramMailingService_load  — load a single record of an entity
//
