...
#      offline in seeded test mode (TelegramMailingServiceSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "TelegramMailingService_sdk.rb")
  SDK_CLASS = "TelegramMailingServiceSDK"
  ...
  SDK_BASE = "TelegramMailingService_sdk"
