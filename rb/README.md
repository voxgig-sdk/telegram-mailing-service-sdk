...
The Ruby SDK for the TelegramMailingService API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `TelegramMailingServiceError` (a `StandardError` subclass), so wrap
