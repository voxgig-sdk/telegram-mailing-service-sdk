...
type TelegramMailingServiceSDK struct {
	Mode     string
...
func (sdk *TelegramMailingServiceSDK) OptionsMap() map[string]any {
...
func (sdk *TelegramMailingServiceSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TelegramMailingServiceSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TelegramMailingServiceSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TelegramMailingServiceSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TelegramMailingServiceSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TelegramMailingServiceSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TelegramMailingServiceSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TelegramMailingServiceSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TelegramMailingServiceSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TelegramMailingServiceSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *TelegramMailingServiceSDK {
	...
	sdk := NewTelegramMailingServiceSDK(sdkopts)
	sdk.Mode = "test"
