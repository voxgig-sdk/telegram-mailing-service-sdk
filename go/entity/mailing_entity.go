...
type MailingEntity struct {
	name    string
	client  *core.TelegramMailingServiceSDK
...
func NewMailingEntity(client *core.TelegramMailingServiceSDK, entopts map[string]any) *MailingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MailingEntity) GetName() string { return e.name }
...
func (e *MailingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MailingEntity) Deleted() bool {
	return e.deleted
}


func (e *MailingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMailingEntity(e.client, opts)
}

func (e *MailingEntity) Data(args ...any) any {
...
func (e *MailingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *MailingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MailingEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *MailingEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *MailingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *MailingEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
func (e *MailingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
