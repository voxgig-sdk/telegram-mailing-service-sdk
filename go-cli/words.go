...
func registerSDKWords(r *eng.Registry, client *sdk.TelegramMailingServiceSDK) {
...
func runOp(client *sdk.TelegramMailingServiceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
