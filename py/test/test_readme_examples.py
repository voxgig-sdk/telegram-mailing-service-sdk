# TelegramMailingService SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TelegramMailingServiceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TelegramMailingServiceSDK(...) and TelegramMailingServiceSDK.test(...) become
#      TelegramMailingServiceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "telegrammailingservice_sdk"
_SDK_CLASS = "TelegramMailingServiceSDK"
