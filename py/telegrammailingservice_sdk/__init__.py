...
from telegrammailingservice_sdk.utility import register

# Load features
from telegrammailingservice_sdk.feature.base_feature import TelegramMailingServiceBaseFeature
from telegrammailingservice_sdk.features import _has_feature, _make_feature
...
class TelegramMailingServiceSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = TelegramMailingServiceUtility()
    ...
    def get_utility(self):
        return TelegramMailingServiceUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TelegramMailingServiceSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Mailing(self, data=None) -> "MailingEntity":
        ...
        from telegrammailingservice_sdk.entity.mailing_entity import MailingEntity
