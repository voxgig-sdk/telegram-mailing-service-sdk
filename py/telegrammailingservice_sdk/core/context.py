...
from telegrammailingservice_sdk.core.helpers import get_ctx_prop, to_map
...
class TelegramMailingServiceContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = TelegramMailingServiceControl()
        ...
        if isinstance(sp, TelegramMailingServiceSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TelegramMailingServiceResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TelegramMailingServiceResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return TelegramMailingServiceOperation({})
    ...
    def make_error(self, code, msg):
        return TelegramMailingServiceError(code, msg, self)
