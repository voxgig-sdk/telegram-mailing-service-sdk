...
from telegrammailingservice_sdk.telegrammailingservice_types import (
    Mailing,
    MailingLoadMatch,
    MailingListMatch,
    MailingCreateData,
...
class MailingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MailingEntity(self._client, opts)
    ...
    def create(self, reqdata: MailingCreateData, ctrl=None) -> Mailing:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
