...
class TelegramMailingServiceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TelegramMailingServiceTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = TelegramMailingServiceTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = TelegramMailingServiceTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
