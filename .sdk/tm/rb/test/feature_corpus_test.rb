# TelegramMailingService SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # TelegramMailingServiceSDK.new, not TelegramMailingServiceSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    TelegramMailingServiceSDK.new(opts)
  end
