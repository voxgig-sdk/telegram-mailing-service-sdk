...
// TelegramMailingService SDK utility: make_options

class TelegramMailingServiceMakeOptions
{
    ...
    public static function call(TelegramMailingServiceContext $ctx): array
    {
        ...
        //
        // `TelegramMailingServiceSchema::optspec()` is built from the model:
        ...
        $optspec = TelegramMailingServiceSchema::optspec();
