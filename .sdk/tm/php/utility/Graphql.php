...
// TelegramMailingService SDK utility: graphql
//
...
class TelegramMailingServiceGraphql
{
    ...
    // equivalent.
    public static function body(TelegramMailingServiceContext $ctx): mixed
    {
    ...
    public static function errors(TelegramMailingServiceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
