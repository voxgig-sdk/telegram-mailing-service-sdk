...
// TelegramMailingService SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class TelegramMailingServiceMakeSpec
{
    public static function call(TelegramMailingServiceContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = TelegramMailingServiceGraphql::CONTENT_TYPE;
        } else {
