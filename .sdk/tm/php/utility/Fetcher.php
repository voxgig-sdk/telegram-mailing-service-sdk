...
// TelegramMailingService SDK utility: fetcher

class TelegramMailingServiceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TelegramMailingServiceSDK/1.0)';
    ...
    public static function call(TelegramMailingServiceContext $ctx, string $fullurl, array $fetchdef): array
    {
