...
// TelegramMailingService SDK idempotency feature
...
class TelegramMailingServiceIdempotencyFeature extends TelegramMailingServiceBaseFeature
{
    ...
    private function _mutating(TelegramMailingServiceContext $ctx): bool
    {
