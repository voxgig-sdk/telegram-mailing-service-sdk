...
// TelegramMailingService SDK streaming feature
...
class TelegramMailingServiceStreamingFeature extends TelegramMailingServiceBaseFeature
{
    ...
    private function _iterate(TelegramMailingServiceResult $result): \Generator
    {
    ...
    private function _streamable(TelegramMailingServiceContext $ctx): bool
    {
