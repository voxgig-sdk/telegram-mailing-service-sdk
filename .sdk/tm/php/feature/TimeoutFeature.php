...
// TelegramMailingService SDK timeout feature
...
class TelegramMailingServiceTimeoutFeature extends TelegramMailingServiceBaseFeature
{
    ...
    private function _with_timeout(TelegramMailingServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TelegramMailingServiceContext $_ctx, float $ms): void
    {
        $client = $this->client;
