...
// TelegramMailingService SDK clienttrack feature
...
class TelegramMailingServiceClienttrackFeature extends TelegramMailingServiceBaseFeature
{
    ...
    public function PostConstruct(TelegramMailingServiceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TelegramMailingService-SDK';
