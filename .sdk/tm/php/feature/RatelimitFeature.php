...
// TelegramMailingService SDK ratelimit feature
...
class TelegramMailingServiceRatelimitFeature extends TelegramMailingServiceBaseFeature
{
    ...
    private function _acquire(TelegramMailingServiceContext $ctx): void
    {
    ...
    private function _track(TelegramMailingServiceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
