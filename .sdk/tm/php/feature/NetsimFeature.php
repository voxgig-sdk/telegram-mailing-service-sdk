...
// TelegramMailingService SDK netsim feature
...
class TelegramMailingServiceNetsimFeature extends TelegramMailingServiceBaseFeature
{
    ...
    private function _simulate(TelegramMailingServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TelegramMailingServiceContext $ctx, array $applied): void
    {
        $client = $this->client;
