...
// TelegramMailingService SDK proxy feature
...
class TelegramMailingServiceProxyFeature extends TelegramMailingServiceBaseFeature
{
    ...
    public function init(TelegramMailingServiceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TelegramMailingServiceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
