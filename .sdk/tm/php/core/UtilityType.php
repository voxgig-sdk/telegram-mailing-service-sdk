...
// TelegramMailingService SDK utility type

class TelegramMailingServiceUtility
{
    ...
    public static function copy(TelegramMailingServiceUtility $src): TelegramMailingServiceUtility
    {
        $u = new TelegramMailingServiceUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
