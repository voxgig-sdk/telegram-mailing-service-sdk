...
// TelegramMailingService SDK pipeline test
//
...
{
    private static function utility(): TelegramMailingServiceUtility
    {
        return new TelegramMailingServiceUtility();
    }
    ...
    private static function ctx(array $over = []): TelegramMailingServiceContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new TelegramMailingServiceContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new TelegramMailingServiceOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof TelegramMailingServiceError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new TelegramMailingServiceOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = TelegramMailingServiceMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new TelegramMailingServiceOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = TelegramMailingServiceMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new TelegramMailingServiceOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = TelegramMailingServiceMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TelegramMailingServiceSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = TelegramMailingServiceMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new TelegramMailingServiceResponse([]),
            'result' => new TelegramMailingServiceResult([]),
        ]);
        [, $err] = TelegramMailingServiceMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new TelegramMailingServiceSpec([]),
            'response' => null,
            'result' => new TelegramMailingServiceResult([]),
        ]);
        [, $err] = TelegramMailingServiceMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new TelegramMailingServiceSpec(['step' => 's']),
            'response' => new TelegramMailingServiceResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new TelegramMailingServiceResult([]),
        ]);
        [, $err] = TelegramMailingServiceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new TelegramMailingServiceSpec(['step' => 's']),
            'response' => new TelegramMailingServiceResponse(self::resp(200, ['v' => 1])),
            'result' => new TelegramMailingServiceResult([]),
        ]);
        [, $err] = TelegramMailingServiceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new TelegramMailingServiceSpec(['step' => 's']),
            'response' => new TelegramMailingServiceResponse(self::resp(200, ['v' => 2])),
            'result' => new TelegramMailingServiceResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        TelegramMailingServiceMakeResponse::call($ctx);
    ...
    {
        $preset = new TelegramMailingServiceResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new TelegramMailingServiceSpec([]),
            'response' => new TelegramMailingServiceResponse([]),
            'result' => new TelegramMailingServiceResult([]),
        ...
        [$got, $err] = TelegramMailingServiceMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new TelegramMailingServiceResult([])]);
        [, $err] = TelegramMailingServiceMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new TelegramMailingServiceSpec([]), 'result' => null]);
        [, $err] = TelegramMailingServiceMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TelegramMailingServiceSpec(['step' => 's']),
            'result' => new TelegramMailingServiceResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new TelegramMailingServiceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TelegramMailingServiceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TelegramMailingServiceSpec(['step' => 's']),
            'result' => new TelegramMailingServiceResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new TelegramMailingServiceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TelegramMailingServiceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TelegramMailingServiceResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new TelegramMailingServiceSpec([]),
            'result' => new TelegramMailingServiceResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = TelegramMailingServiceMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TelegramMailingServiceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new TelegramMailingServiceError('boom', 'boom');
        $utility->fetcher = function (TelegramMailingServiceContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TelegramMailingServiceSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = TelegramMailingServiceMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (TelegramMailingServiceContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = TelegramMailingServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(TelegramMailingServiceResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        TelegramMailingServiceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (TelegramMailingServiceContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TelegramMailingServiceSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = TelegramMailingServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new TelegramMailingServiceResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new TelegramMailingServiceSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = TelegramMailingServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = TelegramMailingServiceMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = TelegramMailingServiceMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new TelegramMailingServiceResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, TelegramMailingServiceDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new TelegramMailingServiceResult(['ok' => false])]);
        $this->expectException(TelegramMailingServiceError::class);
        TelegramMailingServiceDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new TelegramMailingServiceResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', TelegramMailingServiceMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        TelegramMailingServiceMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new TelegramMailingServiceBaseFeature();
        $b = new TelegramMailingServiceBaseFeature();
        TelegramMailingServiceFeatureAdd::call($ctx, $a);
        TelegramMailingServiceFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): TelegramMailingServiceBaseFeature
    {
        $f = new TelegramMailingServiceBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        TelegramMailingServiceFeatureAdd::call($ctx, self::named_feature('a'));
        TelegramMailingServiceFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        TelegramMailingServiceFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        TelegramMailingServiceFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        TelegramMailingServiceFeatureAdd::call($ctx, $replace);
        ...
        TelegramMailingServiceFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): TelegramMailingServiceContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new TelegramMailingServiceSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TelegramMailingServicePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        TelegramMailingServicePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new TelegramMailingServiceResponse(['headers' => null]),
            'result' => new TelegramMailingServiceResult([]),
        ]);
        TelegramMailingServiceResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        TelegramMailingServiceResultBody::call($ctx);
