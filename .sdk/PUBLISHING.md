...
|---|---|---|
| `ts/` | @voxgig-sdk/telegram-mailing-service-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/telegram-mailing-service-sdk \
      --repository voxgig-sdk/telegram-mailing-service-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/telegram-mailing-service-sdk` shows it, and
`npm trust revoke @voxgig-sdk/telegram-mailing-service-sdk --id=<id>` removes it.
